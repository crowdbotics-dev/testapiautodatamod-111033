...
## Project Structure
    ...
    ├── testapiautodatamod_111033  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_111033`
...
2. Clone this repo and `cd testapiautodatamod_111033`
